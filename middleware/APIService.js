    ...
    return axios
      .put(url, {
        params: {
          estado: tipoContrato,
          observaciones:
            "por medio del presente instrumento transfiere a título de compraventa real y efectiva al COMPRADOR el derecho de dominio y la posesión que tiene y ejerce sobre",
          valor: dineroN,
